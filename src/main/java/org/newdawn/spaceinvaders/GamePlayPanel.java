...
public class GamePlayPanel extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2d.setColor(Color.black);
        // 폰트를 안전한 SansSerif로 설정하고 기호를 '$'로 변경
        g2d.setFont(new Font("SansSerif", Font.BOLD, 18));
        g2d.drawString("$", badgeX+13, badgeY+28); // 기호를 '$'로 변경하고 위치 미세 조정
        // 코인 개수를 그리기 전에 폰트를 원래대로 돌려놓거나 새로 지정
        g2d.setFont(new Font("Arial", Font.BOLD, 12)); // 폰트를 명시적으로 설정
        ...
        if (game.shopOpen) {
            ...
            // Game 객체에서 RankingManager를 통해 점수를 가져옵니다.
